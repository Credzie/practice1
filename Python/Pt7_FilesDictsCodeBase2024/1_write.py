...
# filePath1 = open('Python/Pt7_FilesDictsCodeBase2024/file1.txt', 'w')
filePath1 = open('Python/Pt7_FilesDictsCodeBase2024/morepracticefile.txt', 'w')
# write to file
filePath1.write("Python Programming practice learning how to opening new files and connecting user input")
