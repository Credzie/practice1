...
#----If statements in JS are written in curly brackets while it is written after the : in Python
#----JS uses Else if while python uses Elif in if statements
